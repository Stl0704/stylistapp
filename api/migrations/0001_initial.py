# Generated by Django 5.0.3 on 2024-06-02 04:27
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tipo_usuario', models.CharField(choices=[('cliente', 'Cliente'), ('prestador', 'Prestador')], max_length=50)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('foto', models.CharField(default='Descripción no proporcionada', max_length=1000)),
                ('descripcion', models.TextField(default='Descripción no proporcionada', max_length=200)),
            ],
        ),
        migrations.CreateModel(
            name='Cita',
            fields=[
                ...
                ('boleta', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='cita_cita', to='api.boleta')),
        ...
        migrations.AddField(
            model_name='boleta',
            name='cita',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='boleta_boletas', to='api.cita'),
        ),
        migrations.CreateModel(
            name='Cliente',
            fields=[
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('calificacion', models.DecimalField(decimal_places=2, max_digits=3, validators=[django.core.validators.MinValueValidator(0), django.core.validators.MaxValueValidator(5)])),
            ],
            options={
                'abstract': False,
                'base_manager_name': 'objects',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('foto', models.CharField(default='Imagen no proporcionada', max_length=1000)),
        ...
        migrations.AddField(
            model_name='cita',
            name='prestador_serv',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='api.prestadorservicios'),
        ),
    ]
